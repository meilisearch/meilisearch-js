...
describe.each([
  ...
  beforeAll(async () => {
    ...
    await masterClient.getIndex<Movie>(index.uid).waitForPendingUpdate(updateId)
  })
  ...
  test(`${permission} key: Try to Search on deleted index and fail`, async () => {
    ...
    await expect(
      client.getIndex<Movie>(index.uid).search('prince', {}, 'GET')
