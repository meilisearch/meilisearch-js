...
export type MatchesPosition<T> = Partial<Record<keyof T, Array<{ start: number; length: number }>>>;
...
export type DocumentsResults<T = Record<string, any>> = ResourceResults<Documents<T>> & {};
