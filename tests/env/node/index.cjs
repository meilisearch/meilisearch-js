const { MeiliSearch, default: DefaultMeiliSearch } = require('../../../dist/cjs/index.cjs')
...
const DefaultCJSTest = new DefaultMeiliSearch({ host:'http://localhost:7700', apiKey: 'masterKey' })
